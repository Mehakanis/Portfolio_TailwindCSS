...
export default function HeroSection() {
  return (
    ...
    />
          ...
          <div>
            <Link href="/contact">
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-200 text-white" id="Contact">Hire Me</button></Link>
           <a href="https://milestones1-2-ebon.vercel.app/">
